...
# Omit carrier to include carrier_on_time (per-marketing-carrier on-time rate, same 0–1 scale as
# on_time_rate, plus flight counts). The field is omitted entirely when carrier is set.
